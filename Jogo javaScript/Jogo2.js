...
var imgREDfantasma; //variavel para receber uma imagem
var imgBLUEfantasma; //variavel para receber uma imagem
...
var fonte3; //variavel para receber uma fonte para textos
var fonte4; //variavel para receber uma fonte para textos
var fonte5; //variavel para receber uma fonte para textos
var fonte6; //variavel para receber uma fonte para textos
...
function preload(){
	...
	imgREDfastasma = loadImage("imagens/fatasmaRED.png");
	imgBLUEfantasma = loadImage("imagens/fantasmaBLUE.png");
	...
	fonte3 = loadFont("Fontes/fonte3/fonte3.ttf");
	fonte4 = loadFont("Fontes/fonte4/fonte4.ttf");
	fonte5 = loadFont("Fontes/fonte5/fonte5.ttf");
	fonte6 = loadFont("Fontes/fonte6/fonte6.ttf");
	}
function setup(){
...
function jogo(){
	...
	if(nivel == 2){nivel2();velocidade = 2;}
	if(nivel == 3){nivel3();velocidade = 3;}
	if(nivel == 4){nivel4();velocidade = 4;}
	if(nivel == 5){nivel5();velocidade = 5;}
	if(zerou == 1){
		zerar();zerou = 0;
	}
}
...
function nivel1(){
	...
	if(contadorNivel > n1){nivel = 2;zerou = 1;}
	}
function nivel2(){
	...
	if(contadorNivel > n2){nivel = 3;zerou = 1;}	
	}
function nivel3(){
	...
	if(contadorNivel > n3){nivel = 4;zerou = 1;}
}
function nivel4(){
	...
	if(contadorNivel > n4){nivel = 5;zerou = 1;}
}
function nivel5(){
